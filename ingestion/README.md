...
> *[SCREENSHOT CUE 2: Insert an image of the ADF Author tab, showing the white canvas with the 'Copy Data' activity and the pipeline name `pl_ingest_opensky_flights` visible on the left.]*
